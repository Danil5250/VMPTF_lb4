...
const ServicesPageHighlight: React.FC = () => {
    ...
    const [maxFilters, setMaxFilters] = useState({
        maxPrice: '',
        maxGarantee: 170,
        maxDuration: 260
    });
    ...
    useEffect(() => {
        ...
        setPriceRange([0, Number(maxFilters.maxPrice)])
        setWarrantyRange([0, maxFilters.maxGarantee])
        setDurationRange([0, maxFilters.maxDuration])
    }, [maxFilters]);
    ...
    useEffect(() => {
        ...
        const fetchServicesFilterMax = async () => {
            try {
                const result = await getServicesFiltersMax()
                setMaxFilters(result.data)
            }
            catch (err) {
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="bg-white p-4 rounded-lg shadow">
                            ...
                            <div className="space-y-2">
                                ...
                                {/* Ползунок для мінімального значення */}
                                <input
                                    type="range"
                                    min="0"
                                    max={maxFilters.maxPrice}
                                    step="100"
                                    value={priceRange[0]}
                                    onChange={(e) => setPriceRange([Number(e.target.value), priceRange[1]])}
                                    className="w-full"
                                />
                                {/* Ползунок для максимального значення */}
                                <input
                                    type="range"
                                    min="0"
                                    max={maxFilters.maxPrice}
                                                    ...
                                                    <div className="lg:col-span-2 space-y-6">
                                                        <div>
                                                            ...
                                                            <p className="text-gray-700 leading-relaxed">
                                                                <HighlightText text={service.description} highlight={searchQuery} />
                                                                {/*{service.description}*/}
                                                            </p>
                                                        </div>
...
export default ServicesPageHighlight;