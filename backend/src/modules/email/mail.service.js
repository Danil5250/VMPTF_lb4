...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
        ...
        MailService_1.prototype.sendMail = function (to, subject, text, html) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.transporter.sendMail({
                                    from: "\"AutoRepair System\" <".concat(process.env.EMAIL_USER, ">"),
                                    to: to,
                                    subject: subject,
                                    text: text,
                                    html: html,
                        ...
                        case 2:
                            ...
                            throw new common_1.InternalServerErrorException('Помилка при відправці пошти');
