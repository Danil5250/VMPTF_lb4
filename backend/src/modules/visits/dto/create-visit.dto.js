...
var CreateVisitDto = function () {
    ...
    var _is_urgent_decorators;
    var _is_urgent_initializers = [];
    var _is_urgent_extraInitializers = [];
    ...
    return _a = /** @class */ (function () {
            function CreateVisitDto() {
                ...
                this.is_urgent = (__runInitializers(this, _visit_carid_extraInitializers), __runInitializers(this, _is_urgent_initializers, void 0));
                this.visit_autorepairId = (__runInitializers(this, _is_urgent_extraInitializers), __runInitializers(this, _visit_autorepairId_initializers, void 0));
        ...
        (function () {
            ...
            _car_brand_decorators = [(0, class_validator_1.IsString)()];
            _car_model_decorators = [(0, class_validator_1.IsString)()];
            ...
            _car_licensePlate_decorators = [(0, class_validator_1.IsString)()];
            _car_vin_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Matches)(/^[A-Za-z0-9]{6,17}$/, { message: 'VIN should be 6-17 alphanumeric' })];
            _client_name_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Length)(1, 255)];
            _client_surname_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Length)(1, 255)];
            ...
            _client_email_decorators = [(0, class_validator_1.IsEmail)()];
            ...
            _client_password_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Length)(0, 100)];
            ...
            _is_urgent_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsBoolean)()];
            ...
            __esDecorate(null, null, _is_urgent_decorators, { kind: "field", name: "is_urgent", static: false, private: false, access: { has: function (obj) { return "is_urgent" in obj; }, get: function (obj) { return obj.is_urgent; }, set: function (obj, value) { obj.is_urgent = value; } }, metadata: _metadata }, _is_urgent_initializers, _is_urgent_extraInitializers);
